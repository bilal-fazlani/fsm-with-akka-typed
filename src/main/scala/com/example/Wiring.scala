...
object Wiring {
  ...
  implicit lazy val system: ActorSystem[Message]        = ActorSystem(Behaviors.empty, "system")
  ...
  implicit lazy val actorRef: Future[ActorRef[Message]] = system.systemActorOf(Actors.write(""), "actor1")
}
